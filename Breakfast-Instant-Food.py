...
import os
import json
from db_config import url, Breakfast_instant_food
...
SECTION = "Breakfast & Instant Food"

# =========================
# Cache Folder
# =========================
FOLDER = r"D:\blinkit\Breakfast-instant-food"
...
for cat in cats:
    ...
    while True:
        ...
        for block in items:
            ...
            Breakfast_instant_food.update_one(
                {"pid": pid},
                {"$setOnInsert": doc},
                upsert=True
            )
