...
import os
import json
from db_config import url, Ice_Cream_Frozen_Desserts
...
SECTION = "Ice Cream & Frozen Desserts"

# =========================
# Cache Folder
# =========================
FOLDER = r"D:\blinkit\Ice_Cream_Frozen_Desserts"
...
for cat in cats:
    ...
    while True:
        ...
        for block in items:
            ...
            Ice_Cream_Frozen_Desserts.update_one(
                {"pid": pid},
                {"$setOnInsert": doc},
                upsert=True
            )
