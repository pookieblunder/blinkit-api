...
import os
import json
from db_config import url, Tea_Coffee_HealthDrinks
...
SECTION = "Tea, Coffee & Health Drinks"

# =========================
# Cache Folder
# =========================
FOLDER = r"D:\blinkit\Tea-Coffee & Health-Drinks"
...
for cat in cats:
    ...
    while True:
        ...
        for block in items:
            ...
            Tea_Coffee_HealthDrinks.update_one(
                {"pid": pid},
                {"$setOnInsert": doc},
                upsert=True
            )
